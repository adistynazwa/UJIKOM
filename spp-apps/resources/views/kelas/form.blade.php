                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="nama_kelas" placeholder="Nama" value="{{ isset($kelas) ? $kelas->nama_kelas : old('nama_kelas') }}" required>
                            </div>
                            <div class="form-group">
                                <label class="form-label">Kompetensi Kehalian</label>
