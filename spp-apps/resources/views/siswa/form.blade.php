                        ...
                        <div class="col-12">
                            ...
                            <div class="form-group">
                                ...
                                <select id="select-beast" class="form-control custom-select" name="kelas_id">
                                    ...
                                    <option value="{{ $item->id }}" {{ isset($siswa) ? ($item->id == $siswa->kelas_id ? 'selected' : '') : '' }}>{{ $item->nama_kelas }}</option>
                                        {{-- <option value="{{ $item->id }}" {{ isset($siswa) ? ($item->id == $siswa->kelas_id ? 'selected' : '') : '' }}>{{ $item->nama_kelas }} - {{ isset($item->periode) ? $item->periode->nama : '' }}</option> --}}
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="nisn" placeholder="NISN" value="{{ isset($siswa) ? $siswa->nisn : old('nisn') }}">
                            </div>
                            <div class="form-group">
                                <label class="form-label">NIS</label>
                                <input type="text" class="form-control" name="nis" placeholder="NIS" value="{{ isset($siswa) ? $siswa->nis : old('nis') }}">
                            </div>
                            {{-- <div class="form-group">
